...
import 'package:aduio_player/features/widgets/seek_bar.dart';
import 'package:aduio_player/features/widgets/spinning_disc_animation.dart';
...
import '../../bloc/player/player_bloc.dart' as bloc;
...
class _PlayerBottomAppBarState extends State<PlayerBottomAppBar> {
  ...
  Future<void> _getPlaylist() async {
    ...
    SongModel? lastPlayedSong = await sl<RecentRepository>().fetchLastPlayed();
